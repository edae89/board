...
<body>
	<div id="wrap" align="center">
		<h1>답글 등록</h1>
		<form name="frm" method="post" action="BoardServlet?command=board_reply&userid=${sessionScope.userid}&num=${num}">
			...
			<br> <input type="submit" value="등록"
				...
				onclick="location.href='BoardServlet?command=board_reply&userid=${sessionScope.userid}&num=${num}'">
		</form>
	</div>
</body>
</html>